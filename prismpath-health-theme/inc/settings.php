...
function prismpath_default_settings(): array
{
    return array(
        ...
        'footer_description' => 'Neuroaffirming mental health care for individuals, couples, caregivers, and family systems.',
        'footer_microcopy' => 'Virtual care nationwide where provider licensure allows.',
...
function prismpath_render_settings_page(): void
{
    ...
    $fields = array(
        ...
        'footer_microcopy' => 'Footer Microcopy',
